...
if(isset($_GET['upd']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['upd'];
    $upd1=mysqli_query($dbcon,"update hos_reg set st='1' where uid='$uid'");
    ...
    if($upd2>0)
    {
       header("location:approved-amb.php");
}
}                         
...
if(isset($_GET['del']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['del'];
    $upd1=mysqli_query($dbcon,"update hos_reg set st='2' where uid='$uid'");
                ...
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from ambulance where st='1'");
                        ...
                        <div class="emply-resume-list row mb-3">
                            ...
                            <div class="col-md-3  text-right">
                                <div class="btn btn-danger"><a href="approved-amb.php?del=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[5] ?>"><b style="color: white">Reject</b></a></div>
