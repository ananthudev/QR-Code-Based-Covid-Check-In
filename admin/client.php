...
if(isset($_GET['del']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['del'];
    $upd1=mysqli_query($dbcon,"update client_reg set st='2' where id='$upd'");
                ...
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from client_reg where st='1'");
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                ...
                                <div class="emply-resume-info">
                                    <h4><a href="cl_dt.php?mid=<?php echo $r_gal[5] ?>"><?php echo $r_gal[1] ?></a></h4>
                            ...
                            <div class="col-md-3  text-right">
                                <div class="btn btn-danger"><a href="client.php?del=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[5] ?>"><b style="color: white">Reject</b></a></div>
