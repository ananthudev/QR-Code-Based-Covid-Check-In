...
if(isset($_GET['upd']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['upd'];
    $upd1=mysqli_query($dbcon,"update client_reg set st='1' where em='$uid'");
...
if(isset($_GET['del']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['del'];
    $upd1=mysqli_query($dbcon,"update client_reg set st='2' where em='$uid'");
                ...
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from client_reg where st='0'order by id desc");
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                <div class="emply-img">
                                    <img style="width: 100%;height: 130px" src="../img2/<?php echo $r_gal[7] ?>" alt="" class="img-fluid">
                                </div>
                            ...
                            <div class="col-md-3  text-right">
                                <div class="btn btn-success"><a href="client_enq.php?upd=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[5] ?>"><b style="color: white">Approve</b></a></div>&nbsp;&nbsp;<div class="btn btn-danger"><a href="client_enq.php?del=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[5] ?>"><b style="color: white">Reject</b></a></div>
