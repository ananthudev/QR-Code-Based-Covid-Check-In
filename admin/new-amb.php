...
if(isset($_GET['upd']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['upd'];
    $upd1=mysqli_query($dbcon,"update ambulance set st='1' where uid='$uid'");
...
if(isset($_GET['del']))
{
    $uid=$_GET['uid'];  
    $upd=$_GET['del'];
    $upd1=mysqli_query($dbcon,"update ambulance set st='2' where uid='$uid'");
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    <span>Enquiry</span>Ambulance</h3>
					<!---728x90--->
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from ambulance where st='0'order by id desc");
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                <div class="emply-img">
                                    <img style="width: 100%;" src="../img4/<?php echo $r_gal[7] ?>" alt="" class="img-fluid">
                                </div>
                                <div class="emply-resume-info">
                                    ...
                                    <ul class="links_bottom_emp mt-2">
                                        <li><a href="#"><i class="far fa-user"></i> <span class="icon_text"> <?php echo $r_gal[5] ?></span></a></li>
                            ...
                            <div class="col-md-3  text-right">
                                <div class="btn btn-success"><a href="new-amb.php?upd=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[5] ?>"><b style="color: white">Approve</b></a></div>&nbsp;&nbsp;<div class="btn btn-danger"><a href="new-amb.php?del=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[5] ?>"><b style="color: white">Reject</b></a></div>
