    ...
    <div class="invoice-container">
        <div class="invoice-header">
            <div class="title-date">
                ...
                <p class="date">Positive Cases</p>
            </div>
            <div class="space"></div>
            <p class="invoice-number"><b><?php echo $mid ?></b></p>
        </div>
            ...
            <table class="table table-responsive table-bordered">
                ...
                <tbody id="table-body">
                     <?php
                                                      ...
                                                      $sel_gal1=mysqli_query($dbcon,"select * from c_test1 where  res='Positive' and dt like '$mid%' order by id desc");
