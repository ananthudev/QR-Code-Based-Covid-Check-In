...
<?php
                    ...
                    if(isset($_POST['b1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $ins=mysqli_query($dbcon,"update client_reg set nme='$t1',mc='$t2',addr='$t3',cont='$t4',em='$t5' where em='$usr'");
	...
	<section class="banner-bottom-wthree pt-lg-5 pt-md-3 pt-3">
		...
		<!---728x90--->
			<h3 class="tittle text-center mb-lg-5 mb-3">
				<span>Update Info</span>Shop</h3>
				<!---728x90--->
				
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 map">
                                            <img style="width: 100%;height: 1200px" src="../pic/Registration-and-stamp-duty-fees-1.jpg">
						...
						<div class="form">
							...
							<form method="post"enctype="multipart/form-data">
								<div class="form-group">
									...
									<input class="form-control" type="text" value="<?php echo $r[1] ?>"name="t1" placeholder="" required="">
								</div>
                                                            <div class="form-group">
									<label class="my-2">Main Controller</label>
									<input class="form-control" type="text"value="<?php echo $r[2] ?>" name="t2" placeholder="" required=""onkeyup="nme(this.value)" /><span id="np3"></span>
								</div>
                                                            <div class="form-group">
									<label>Address</label>
									<textarea id="textarea" placeholder=""name="t3"><?php echo $r[3] ?></textarea>
								</div>
                                                            
                                                            <div class="form-group">
									<label>Contact</label>
									<input class="form-control" type="text" name="t4"value="<?php echo $r[4] ?>" placeholder="" required=""onkeyup="chkc(this.value)" /><span id="o3"></span>
								</div>
								<div class="form-group">
									<label>Email</label>
									<input class="form-control" type="email" value="<?php echo $r[5] ?>"name="t5" placeholder="" required=""onkeyup="vem(this.value)" /><span id="em"></span>
								</div>
								
								<div class="input-group1">
									<input class="form-control" type="submit"name="b1"id="btn" value="Submit">
								</div>
							</form>
						</div>
					</div>
