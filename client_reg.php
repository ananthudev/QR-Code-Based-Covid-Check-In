...
if(mysqli_num_rows($log1)>0)
{
 echo '<script>alert("Email Already Exist")</script>'; 
   ...
   $count=rand('100000','999999');
    ...
    {
    $ins=mysqli_query($dbcon,"insert into client_reg values('','$t1','$t2','$t3 pincode-$pin','$t4','$t5','$t6','$nfn','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t5','$t6','client','0')");
        if($ins1>0)
        {
	...
	<section class="banner-bottom-wthree pt-lg-5 pt-md-3 pt-3">
		...
		<!---728x90--->
			<h3 class="tittle text-center mb-lg-5 mb-3">
				<span>Registration</span>Shop</h3>
				<!---728x90--->
