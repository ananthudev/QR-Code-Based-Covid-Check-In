...
$mid=$_GET['mid'];
$uid=$_GET['uid'];
$act=mysqli_query($dbcon,"select * from entry where id='$mid'");
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    <span>Activity</span>Possible Contact</h3>
					<!---728x90--->
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         <?php
                                                        ...
                                                        $sel_gal1=mysqli_query($dbcon,"select * from entry where cid='$act1[5]'and uid!='$uid' and st='1' and en >= '$act1[2]' and ex <= '$act1[3]'");
