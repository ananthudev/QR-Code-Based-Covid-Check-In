...
$act=mysqli_query($dbcon,"select * from user_data where id='$mid'");
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    <span>Activity</span>Persons Near by</h3>
					<!---728x90--->
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         $la=$act1[5];
                          $lo=$act1[6];
                            $se=mysqli_query($dbcon,"SELECT id, SQRT( POW(69.1 * (la - $la), 2) + POW(69.1 * ($lo - lo) * COS(la / 57.3), 2)) AS distance FROM user_data  HAVING distance < 60 ORDER BY distance");
