...
if(isset($_GET['del']))
{
   ...
   $upd1=mysqli_query($dbcon,"update c_test set res='Positive' where uid='$upd' and hid='$usr'");
    ...
    if($upd1>0)
    {
         $upd2=mysqli_query($dbcon,"update c_test1 set res='Positive' where uid='$upd' and hid='$usr'");
    
   
    if($upd2>0)
    {
        $upd3=mysqli_query($dbcon,"update user_data set covid='Positive'where uid='$upd'");
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    <span>Covid Test</span>Pending</h3>
					<!---728x90--->
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         <?php
                          $sel_gal1=mysqli_query($dbcon,"select * from c_test where hid='$usr' and res='pending'");
                        ...
                        <div class="emply-resume-list row mb-3">
                            ...
                            <div class="col-md-3  text-right">
                                <div class="btn btn-success"><a href="pen.php?upd=<?php echo $r_gal[9] ?>"><b style="color: white">Negative</b></a></div>&nbsp;&nbsp;<div class="btn btn-danger"><a href="pen.php?del=<?php echo $r_gal[9] ?>"><b style="color: white">Positive</b></a></div>
