                    ...
                    if(isset($_GET['upd']))
 {
   ...
   $date=date('Y-m-d');
      $ins1=mysqli_query($dbcon,"insert into c_test values('','$upd','$usr','pending','$date','0')");
        if($ins1>0)
        {
           $ins2=mysqli_query($dbcon,"insert into c_test1 values('','$upd','$usr','pending','$date','0')");
        if($ins2>0)
        {
                    ...
                    <div class="user-detail-info text-center">
                        ...
                        <div class="user-content-info emply-resume-info text-center mt-4">
                            ...
                            <div class="skills-info my-4">
                                ...
                                <a  href="user_dt.php?upd=<?php echo $mid ?>"> <span style="background-color: lightskyblue"  class="mx-3">Admit for Covid Testing <span style="background-color: lightskyblue" class="fa fa-flask"></span></span></a>
