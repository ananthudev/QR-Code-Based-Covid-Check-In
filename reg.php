    ...
    $t6=$_POST['t6'];
     $t7=$_POST['t7'];
      $t8=$_POST['t8'];
       ...
       $t10=$_POST['t10'];
   $pin=$_POST['tpin'];
     $log1=mysqli_query($dbcon,"select * from user_log where uid='$t9'");
if(mysqli_num_rows($log1)>0)
{
 echo '<script>alert("Email Already Exist")</script>'; 
   ...
   $count=rand('100000','999999');
    ...
    {
    $ins=mysqli_query($dbcon,"insert into user_data values('','$t1','$t2','$t3','$t4 pincode-$pin','$t5','$t6','$t7','$t8','$t9','$t10','$nfn','Negative','$ta','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t9','$t10','usr','1')");
        if($ins1>0)
        {
	...
	<section class="banner-bottom-wthree pt-lg-5 pt-md-3 pt-3">
		...
		<!---728x90--->
			<h3 class="tittle text-center mb-lg-5 mb-3">
				<span>Registration</span>User</h3>
				<!---728x90--->
						...
						<div class="form">
							...
							<form method="post"enctype="multipart/form-data">
								<div class="form-group">
									...
									<input class="form-control" type="text" name="t1" placeholder="" required=""onkeyup="nme(this.value)" /><span id="np3"></span>
								</div>
                                                            <div class="form-group">
									<label class="my-2">Gender</label>
                                                                        <select class="form-control"required=""name="t2">
									...
									<input class="form-control" type="date" name="t3" required="">
                                                            ...
                                                            <div class="form-group">
									<label class="my-2">Blood Type</label>
                                                                        <select class="form-control"required=""name="ta">
                                                            ...
                                                            <div class="form-group">
									<label>Address</label>
									<textarea id="textarea" placeholder=""name="t4"></textarea>
								</div>
                                                            <div class="form-group">
									...
									<input type="text" class="form-control" name="t6"placeholder="Double Click on the map" id="lng" value="">
                                                            ...
                                                            <div class="form-group">
									<label>Contact</label>
									<input class="form-control" type="text" name="t7" placeholder="" required=""onkeyup="chkc(this.value)" /><span id="o3"></span>
								</div>
								<div class="form-group">
									<label>Email</label>
									<input class="form-control" type="email" name="t8" placeholder="" required=""onkeyup="vem(this.value)" /><span id="em"></span>
								</div>
                                                            <div class="form-group">
									<label>Aadhar Number(User ID)</label>
									<input class="form-control" type="text" name="t9" placeholder="############" required=""onkeyup="chkc1(this.value)" /><span id="o31"></span>
								</div>
								<div class="form-group">
									<label>password</label>
                                                                        <input class="form-control" type="password" name="t10" placeholder="" required="" >
								</div>
                                                            <div class="form-group">
