...
$act=mysqli_query($dbcon,"select * from user_data where uid='$usr'");
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    <span>Covid Case</span>Near by</h3>
					<!---728x90--->
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-12 job_info_left">
                         ...
                         $la=$act1[5];
                          $lo=$act1[6];
                            $se=mysqli_query($dbcon,"SELECT id, SQRT( POW(69.1 * (la - $la), 2) + POW(69.1 * ($lo - lo) * COS(la / 57.3), 2)) AS distance FROM user_data where covid='Positive'  HAVING distance < 60 ORDER BY distance");
                                                if(mysqli_num_rows($se)>0)
                                                        {$i=0;
                                                        ?>
                        <?php
                                                         while($r_gal1=mysqli_fetch_row($se))
                                                            {
                                                        $sel_gal=mysqli_query($dbcon,"select * from user_data where id='$r_gal1[0]'");
                        ...
                        <div class="emply-resume-list row mb-3">
                            <div class="col-md-9 emply-info">
                                <div class="emply-img">
                                    <img style="width: 190px;height: 170px" src="../img3/<?php echo $r_gal[11] ?>" alt="" class="img-fluid">
                                </div>
                                <div class="emply-resume-info">
                                    <h4><a target="_blank" href="user_dt.php?mid=<?php echo $r_gal[9] ?>"><?php echo $r_gal[1] ?></a></h4>
                                    <h5 class="mt-2"><?php echo $r_gal[2] ?></h5>
